...
// Classes
$$.ActiveSmurfs = {"": "WebComponent;__e7,__t,smurfs<,_host,_shadowRoots,_generatedRoots",
  created_autogenerated$0: function() {
    var root, t1, t2;
    root = this._createShadowRoot$0();
    t1 = this._generatedRoots;
    t1.$indexSet(t1, "activeSmurfs", root);
    this.__t = $.Template$(root);
    t1 = $.getInterceptor$x(root);
    $.add$1$ax(t1.get$nodes(root), $.clone$1$x($.get$ActiveSmurfs___shadowTemplate(), true));
    this.__e7 = $.$index$asx($.get$nodes$x($.$index$asx(t1.get$nodes(root), 1)), 1);
    t1 = this.__t;
    t2 = this.__e7;
    t1.children.push($.LoopTemplate$(t2, new $.ActiveSmurfs_created_autogenerated_anon(this), new $.ActiveSmurfs_created_autogenerated_anon0()));
    this.__t.create$0();
  },
  ...
  makeRequest$1: function(e) {
    $.Primitives_printString("http://localhost:8080");
    $.HttpRequest_getString("http://localhost:8080", null, null).then$1(this.get$requestComplete());
  },
  get$makeRequest: function() {
    return new $.BoundClosure$1(this, "makeRequest$1");
  },
  requestComplete$1: function(request) {
    $.Primitives_printString("stuff");
    $.Primitives_printString($.toString$0(request));
  },
  get$requestComplete: function() {
    return new $.BoundClosure$1(this, "requestComplete$1");
  },
  ActiveSmurfs$0: function() {
    var t1 = this.smurfs;
    t1.push("Smurf1");
    t1.push("Smurf2");
    t1.push("Smurf3");
    t1.push("Smurf4");
    t1.push("Smurf5");
    $.get$onClick$x($.query("#button1")).listen$1(this.get$makeRequest());
  }
};

$$.ActiveSmurfs_created_autogenerated_anon = {"": "Closure;this_0",
  call$0: function() {
    return this.this_0.get$smurfs();
  },
  $isFunction: true
};

$$.ActiveSmurfs_created_autogenerated_anon0 = {"": "Closure;",
  call$3: function($$list, $$index, __t) {
    var __binding6 = __t.contentBind$2(new $.ActiveSmurfs_created_autogenerated__anon($.$index$asx($$list, $$index)), false);
    $.addAll$1$ax(__t, [document.createTextNode(" "), __binding6, $.get$ActiveSmurfs___html1().cloneNode(true), document.createTextNode(" ")]);
  },
  $isFunction: true
};

$$.ActiveSmurfs_created_autogenerated__anon = {"": "Closure;smurf_1",
  call$0: function() {
    return this.smurf_1;
  },
  $isFunction: true
...
$$.HashMap = {"": "Object;_liblib$_length,_strings,_nums,_rest,_liblib$_keys",
  get$length: function(_) {
...
$$._ExpressionObserver = {"": "Object;_liblib3$_id<,_expression,_callback,_debugName,_reads,_unobservers,_scheduled@,_liblib3$_value",
...
$.ActiveSmurfs$ = function() {
  var t1 = $.List_List($, $.JSString);
  $.setRuntimeTypeInfo(t1, [$.JSString]);
  t1 = new $.ActiveSmurfs(null, null, t1, null, null, $.makeLiteralMap([]));
  t1.ActiveSmurfs$0();
  return t1;
};
...
$.init_autogenerated = function() {
  ...
  if (5 >= t1.length)
    throw $.ioore(5);
  __e0 = $.$index$asx($.get$nodes$x(t1[5]), 3);
  t1 = $.ActiveSmurfs$();
  t1.set$host(t1, __e0);
...
Isolate.$lazy($, "__html1", "ActiveSmurfs___html1", "get$ActiveSmurfs___html1", function() {
  return $.BRElement_BRElement();
});
Isolate.$lazy($, "__shadowTemplate", "ActiveSmurfs___shadowTemplate", "get$ActiveSmurfs___shadowTemplate", function() {
...
//@ sourceMappingURL=whoisinthehub.html_bootstrap.dart.js.map
