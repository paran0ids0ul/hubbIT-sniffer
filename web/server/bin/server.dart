...
main() {
  ...
  HttpServer.bind('127.0.0.1', 8080).then((server) {
    server.listen((HttpRequest request) {
      request.response.headers.set("Access-Control-Allow-Origin", "http://127.0.0.1:3030");
      request.response.headers.set("Access-Control-Allow-Credentials", "true");
      request.response.headers.set("Access-Control-Allow-Methods", "OPTIONS, GET, PUT, POST, DELETE");
      request.response.headers.set("Access-Control-Allow-Headers", "Content-Type, Accept, X-Request-With");
