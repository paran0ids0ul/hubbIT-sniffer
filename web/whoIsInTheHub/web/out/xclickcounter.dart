...
class CounterComponent extends WebComponent {
  ...
  void created_autogenerated() {
    ...
    __e5 = __root.nodes[1].nodes[6];
    __t.loop(__e5, () => smurfs, ($list, $index, __t) {
      var smurf = $list[$index];
      var __binding4 = __t.contentBind(() => smurf, false);
